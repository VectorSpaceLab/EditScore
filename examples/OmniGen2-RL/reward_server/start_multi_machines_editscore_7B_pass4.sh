...
model_name=editscore_7B_pass4
model_name_or_path=Qwen/Qwen2.5-VL-7B-Instruct
lora_path=EditScore/EditScore-7B

root_dir=$SHELL_FOLDER

SCRIPT="bash ${root_dir}/step1.sh --num_pass=4 --score_range=25 --tensor_parallel_size=1 --max_num_seqs=64 --max_model_len=1536 --max_num_batched_tokens=98304"
