...
for ((i=0; i<num_gpus_per_machine; i++)); do
    ...
    --save_dir evaluation/GEdit-Bench/results/Qwen-Image-Edit/results_gs${guidance_scale}_16samples_pass1 \
    --num_samples 16 \
    --backbone qwen25vl \
    ...
    > logs/gedit_Qwen-Image-Edit_gs${guidance_scale}_16samples_select_best_pass1_${start_idx}_${end_idx}.log 2>&1 &
done